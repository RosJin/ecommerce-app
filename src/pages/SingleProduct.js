                            ...
                            <div className=" py-3">
                                ...
                                <div className="d-flex gap-10 flex-column my-3">
                                    ...
                                    <p className="product-data">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. <br /> Dicta corrupti
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="bg-white p-3">
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis nobis recusandae maxime
                                ex voluptate porro nisi, temporibus qui consequatur facere fugiat alias suscipit natus
                                nostrum minus quae, quibusdam deserunt sint!
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="reviews">
                                <div className="review mt-4">
                                    ...
                                    <p className="mt-3">
                                        ...
                                        recusandae. Perspiciatis non voluptates ullam aperiam quasi laudantium
                                        cupiditate eum nemo ratione dolorum. Illo explicabo nobis dicta iusto,
                                        laudantium veniam!
                                    </p>
                                </div>
                            </div>
