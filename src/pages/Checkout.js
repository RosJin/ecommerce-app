                    ...
                    <div className="row">
                        <div className="col-7">
                            <div className="checkout-left-data">
                                <h3 className="website-name">HUY</h3>
                                ...
                                <p className="user-details total">Huy Nguyen (huyhoang.hn462@gmail.com)</p>
                            ...
                            <div className="border-bottom py-4">
                                <div className="d-flex gap-10 mb-2 align-items-center">
                                    <div className="w-75 d-flex gap-10">
                                        ...
                                        <div>
                                            <h5 className="total-price">dasd</h5>
                                            <p className="total-price">s / asdsdfsdf</p>
                                        </div>
                                    </div>
                                    <div className="flex-grow-1">
